...
* Winキー + o : コンテクストメニューを表示
    ...
    * Win + o , x : 現在のアクティヴディスプレー内の全てのウィンドウを全画面表示する
    * Win + o , f : 現在のアクティヴディスプレー内の全てのウィンドウを４分割表示する
    * Win + o , t : 現在のアクティヴディスプレー内の全てのウィンドウをBug.n風タイル表示する
    * Win + o , m : 現在のアクティヴディスプレー内の全てのウィンドウを通常画面表示する(MDI的な)
    * Win + o , n : 現在のアクティヴディスプレー内の全てのウィンドウを整列しない
