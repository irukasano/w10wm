...
* Winキー + p : コンテクストメニューを表示

    * Win + P , X : 現在のアクティヴディスプレー内の全てのウィンドウを全画面表示する
    * Win + P , F : 現在のアクティヴディスプレー内の全てのウィンドウを４分割表示する
    * Win + P , T : 現在のアクティヴディスプレー内の全てのウィンドウをBug.n風タイル表示する
    * Win + P , M : 現在のアクティヴディスプレー内の全てのウィンドウを通常画面表示する(MDI的な)
    * Win + P , N : 現在のアクティヴディスプレー内の全てのウィンドウを整列しない
